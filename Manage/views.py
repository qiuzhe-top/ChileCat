...
@site
class upload(CoolBFFAPIView):
    name = _('XXX')
   
    def get_context(self, request, *args, **kwargs):
        #需要填写你的 Access Key 和 Secret Key
        access_key = 'wXCStxg9VlC2fbUlV3CRIE4sxISYaRxHwVsWwXJX'
        secret_key = 'qyZEYCbth2fHMNFMXRHc09l4_bss2YvSpu4O4O6N'
        #构建鉴权对象
        q = Auth(access_key, secret_key)
        #要上传的空间
        bucket_name = 'zhcy-zjjt'
        #上传后保存的文件名
        key = None
